    ...
    <form class="form form-horizontal" id="form1">
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="{{$StaticData['name']}}" id="name" name="name" />
            </div>
        </div>
        <div class="col-xs-12 row cl">
            <label class="form-label col-xs-3 col-sm-3">属性介绍：</label>
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="{{$StaticData['nickname']}}" id="nickname" name="nickname" />
            </div>
        </div>
        <div class="col-xs-12 row cl">
            <label class="form-label col-xs-3 col-sm-3">Value：</label>
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="{{$StaticData['value']}}" id="value" name="value" />
            </div>
        </div>
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <select name="status" style="float:left;" id="status">
                    <option value="1" @if($StaticData['status']==1)selected="selected"@endif>启用</option>
                    <option value="0" @if($StaticData['status']==0)selected="selected"@endif>禁用</option>
                </select>
            </div>
        </div>
