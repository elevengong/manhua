...
<div id="frm_account" class="col-xs-12" style="text-align: center;">
    <form class="form form-horizontal" id="form1">
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9" style="text-align: left;">
                {{$WithdrawDetail[0]['apply_withdraw_ip']}}
            </div>
        </div>
        <div class="col-xs-12 row cl">
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <textarea rows="5" cols="63" name="remark" id="remark">{{$WithdrawDetail[0]['remark']}}</textarea>
            </div>
        </div>
        <div class="col-xs-12 row cl">
            <label class="form-label col-xs-3 col-sm-3">创建时间：</label>
            <div class="col-xs-9 col-sm-9" style="text-align: left;">
                {{$WithdrawDetail[0]['created_at']}}
            </div>
        </div>
        <div class="col-xs-12 row cl">
            <label class="form-label col-xs-3 col-sm-3">更新时间：</label>
            <div class="col-xs-9 col-sm-9" style="text-align: left;">
                {{$WithdrawDetail[0]['updated_at']}}
            </div>
        </div>

        <div class="col-xs-12 row cl" style="text-align: center;">
            <div class="formControls col-xs-12 col-sm-12">
                <input type="button" onclick="updatewithdraworder({{$WithdrawDetail[0]['withdraw_id']}})" class="btn btn-primary" value="更新充值订单" id="btn_add_ok" />
            </div>
        </div>
