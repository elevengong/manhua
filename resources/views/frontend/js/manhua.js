    ...
    soft = {
        ...
        red_none:function(){
            ...
            $(".fi_classify_ul").css("height",$(window).height()/2);
             //$(".shade").css("height",$(document).height()*1);
            $(".shade").css("height",'2000px');
            //弹窗
...
//如果没有上一章节和下一章节
function end(){
    $(".fi_mask,.fi_dialog").show();
    $(".fi_dialog_r p").text("已经是最后一话了...T-T");
    $(".r_body").addClass("r_body_hidden");
}
function beg(){
    $(".fi_mask,.fi_dialog").show();
    $(".fi_dialog_r p").text("已经是第一话了...T-T");
    $(".r_body").addClass("r_body_hidden");
}
...
//         $(".Ashar_box").fadeIn(300);
//     else
//         $(".Ashar_box").fadeOut(300);
// });
